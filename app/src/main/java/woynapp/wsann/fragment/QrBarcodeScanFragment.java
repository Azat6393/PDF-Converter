...
import woynapp.wsann.customviews.MyCardView;
...
public class QrBarcodeScanFragment extends Fragment implements View.OnClickListener, OnPDFCreatedInterface {
    ...
    private void createPdf(String mFilename, Uri uri) {
        mPath = mSharedPreferences.getString(Constants.STORAGE_LOCATION,
        ...
        try {
            ...
            fileUtil.createPdfFromTextFile(new TextToPDFOptions(mFilename, PageSizeUtils.mPageSize, false,
                    "", uri, fontSize, mFontFamily, mFontColor, Constants.DEFAULT_PAGE_COLOR),
    ...
    private void resetValues() {
        ...
        imageToPDFOptions.setBorderWidth(mSharedPreferences.getInt(Constants.DEFAULT_IMAGE_BORDER_TEXT,
        ...
        imageToPDFOptions.setPageSize(mSharedPreferences.getString(Constants.DEFAULT_PAGE_SIZE_TEXT,
                Constants.DEFAULT_PAGE_SIZE));
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if ((requestCode == REQUEST_CODE_FOR_QR_CODE || requestCode == REQUEST_CODE_FOR_BARCODE || requestCode == Constants.REQUEST_CODE_FOR_WRITE_PERMISSION) && grantResults.length > 0) {
    ...
    private void showPermissionDenyDialog(int requestCode) {
        ...
        if (requestCode == REQUEST_CODE_FOR_QR_CODE) {
            ...
            scanType = "Bar-Code";
            permissionType = "Camera";
        } else if (requestCode == Constants.REQUEST_CODE_FOR_WRITE_PERMISSION) {

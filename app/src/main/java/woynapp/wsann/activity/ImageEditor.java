...
import woynapp.wsann.adapter.BrushItemAdapter;
import woynapp.wsann.adapter.ImageFiltersAdapter;
import woynapp.wsann.interfaces.OnFilterItemClickedListener;
import woynapp.wsann.interfaces.OnItemClickListener;
import woynapp.wsann.model.BrushItem;
import woynapp.wsann.model.FilterItem;
import woynapp.wsann.util.BrushUtils;
import woynapp.wsann.util.ImageFilterUtils;
...
public class ImageEditor extends AppCompatActivity implements OnFilterItemClickedListener, OnItemClickListener {
    ...
    public void onBackPressed() {
        ...
        returnIntent.putStringArrayListExtra(Constants.RESULT, mImagePaths);
    ...
    public static Intent getStartIntent(Context context, ArrayList<String> uris) {
        ...
        intent.putExtra(Constants.IMAGE_EDITOR_KEY, uris);
        return intent;
    }
}

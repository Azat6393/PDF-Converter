...
public class FavouritesActivity extends AppCompatActivity {
    ...
    private void storeInitialState() {
        ...
        mKeyState[4] = mSharedPreferences.getBoolean(Constants.HISTORY_KEY, false);
        mKeyState[5] = mSharedPreferences.getBoolean(Constants.ADD_PASSWORD_KEY, false);
        mKeyState[6] = mSharedPreferences.getBoolean(Constants.REMOVE_PASSWORD_KEY, false);
        ...
        mKeyState[13] = mSharedPreferences.getBoolean(Constants.COMPRESS_PDF_KEY, false);
    ...
    private void onBackPressedState() {
        ...
        mSharedPreferences.edit().putBoolean(Constants.HISTORY_KEY, mKeyState[4]).apply();
        mSharedPreferences.edit().putBoolean(Constants.ADD_PASSWORD_KEY, mKeyState[5]).apply();
        mSharedPreferences.edit().putBoolean(Constants.REMOVE_PASSWORD_KEY, mKeyState[6]).apply();
        ...
        mSharedPreferences.edit().putBoolean(Constants.COMPRESS_PDF_KEY, mKeyState[13]).apply();

...
import woynapp.wsann.activity.FavouritesActivity;
...
public class FavouritesFragment extends Fragment
    ...
    private void checkFavourites(SharedPreferences sharedPreferences) {
        ...
        viewVisibility(pref_history, Constants.HISTORY_KEY);
        viewVisibility(pref_add_text, Constants.ADD_TEXT_KEY);
        viewVisibility(pref_add_password, Constants.ADD_PASSWORD_KEY);
        viewVisibility(pref_rem_pass, Constants.REMOVE_PASSWORD_KEY);
        ...
        viewVisibility(pref_compress, Constants.COMPRESS_PDF_KEY);

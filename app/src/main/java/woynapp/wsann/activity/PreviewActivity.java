...
import woynapp.wsann.adapter.PreviewImageOptionsAdapter;
import woynapp.wsann.model.PreviewImageOptionItem;
import woynapp.wsann.util.Constants;
import woynapp.wsann.util.ImageSortUtils;
...
public class PreviewActivity extends AppCompatActivity implements PreviewImageOptionsAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImagesArrayList = intent.getStringArrayListExtra(Constants.PREVIEW_IMAGES);
    ...
    private ArrayList<PreviewImageOptionItem> getOptions() {
        ...
        mOptions.add(new PreviewImageOptionItem(R.drawable.new_up_down, getString(R.string.rearrange_text)));
        mOptions.add(new PreviewImageOptionItem(R.drawable.new_sort, getString(R.string.sort)));
        return mOptions;
    }

...
import woynapp.wsann.model.PDFFile;
...
public class ViewFilesAdapter extends RecyclerView.Adapter<ViewFilesAdapter.ViewFilesHolder>
    ...
    public void onBindViewHolder(@NonNull ViewFilesHolder holder, final int pos) {
        ...
        holder.fileDate.setText(FileInfoUtils.getFormattedDate(pdfFile.getPdfFile()));
    ...
    public void updateDataset() {
        int index = mSharedPreferences.getInt(Constants.SORTING_INDEX, FileSortUtils.getInstance().NAME_INDEX);

...
public class ExtractTextFragment extends Fragment implements MergeFilesAdapter.OnClickListener,
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        PermissionsUtils.getInstance().handleRequestPermissionsResult(mActivity, grantResults,
                requestCode, Constants.REQUEST_CODE_FOR_WRITE_PERMISSION, this::openExtractText);
    }
        ...
        new MaterialDialog.Builder(mActivity)
                ...
                .input(getString(R.string.example), null, (dialog, input) -> {
                    if (StringUtils.getInstance().isEmpty(input)) {
                        ...
                        if (!mFileUtils.isFileExist(inputName + Constants.textExtension)) {
    ...
    private void extractTextFromPdf(String inputName) {
        ...
        String mPath = mStorePath + inputName + Constants.textExtension;
        try {
            ...
            File textFile = new File(mStorePath, inputName + Constants.textExtension);
